...
def canales_partido(team1: str, team2: str, fase: str = "grupos") -> str:
    ...
    Usa el fixture real (fixture_tv.py) con los canales exactos de cada partido.
    Si el partido no está en el fixture (ej: fases finales aún sin definir),
    cae al dato seguro: DSports/DGO, que transmite los 104 partidos.
    """
    try:
        import fixture_tv as ftv
        canales = ftv.canales_de(team1, team2)
        if canales:
            return canales
    except Exception:
        pass

    # Fallback: DSports transmite los 104 partidos del torneo.
    if ARGENTINA in (team1, team2):
        return "📺 TV Pública, Telefe, TyC Sports y DSports"
    return "📺 DSports"
